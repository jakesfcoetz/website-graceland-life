...
class Configuration
{
	const RESELLER_REQUEST_SECRET = '33ee3367733681d3643514615dfb6076f8530340265c7fa91088cd14c44a372a';
	const ERROR_REPORTING_LEVEL = 0;
	const DEPLOYED_HOSTNAME = 'gracelandlife.co.za';
	const BUILDDATE = 1596438907;
